/*! For license information please see index.4909f80a.js.LICENSE.txt */
!(function () {
  var e,
    t,
    r,
  ...
  min-height: 100vh;
`,
          m = "/web-infra-QoS/index";
        var f = () => {
          let e = new URLSearchParams(window.location.search),
            t = e.get("product") || o.PRODUCT.MODERNJS_FRAMEWORK,
            r = e.get("metrics") || o.MENU.BUNDLE_SIZE,
            [l, f] = (0, s.useState)(t),
            [p, E] = (0, s.useState)(r),
            [S, D] = (0, s.useState)([`${t}`]),
        ...
        let m = (e, t, r) =>
          ...
          f = (e) => {
            ...
            return (
              (0, c.useEffect)(() => {
                (async () => {
                  let e = S.map((e) => (0, o.fetchMetrics)(t, e));
                  h({
      ...
      89862: function (e, t, r) {
        ...
        let f = (e) => {
            var t;
            let { productName: r, metrics: n, initialCase: o } = e;
            return (0, i.jsxs)(i.Fragment, {
              children: [
                ...
                (0, i.jsxs)(c.default.Row, {
                  gutter: 40,
                  children: [
                    (0, i.jsx)(c.default.Col, {
                      span: 8,
...
`,
              ...
              children: (0, i.jsxs)(m.default, {
                ...
                children: [
                  ...
                  (0, i.jsxs)(
                    ...
                    {
                      title: (0, i.jsxs)(i.Fragment, {
                        children: [(0, i.jsx)(c.default, {}), " Rsbuild"],
                      }),
                      children: [
                        (0, i.jsxs)(
                          E,
      ...
      91558: function (e, t, r) {
        ...
        let i = 24,
          ...
          o = {
            ...
            [n.RSBUILD]: ["buildColdBootTime", "devColdBootTime"],
          },
          u = {
            [n.MODERNJS_FRAMEWORK]: ["app-initial", "app-initial-rspack"],
            [n.MODERNJS_MODULE]: ["module-library", "module-component"],
  ...
  (l.m = n),
    ...
    (l.O = function (t, r, i, n) {
      ...
      for (var a = 1 / 0, s = 0; s < e.length; s++) {
        for (
          var r = e[s][0], i = e[s][1], n = e[s][2], d = !0, c = 0;
          c < r.length;
          c++
        )
          a >= n &&
  ...
  var a = l.O(void 0, ["707", "378", "361", "700", "797"], function () {
    return l("12303");
  });
  l.O(a);
})();
