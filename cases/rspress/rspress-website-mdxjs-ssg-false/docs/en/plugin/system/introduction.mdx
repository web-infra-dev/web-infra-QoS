...
- [**Custom build tool behavior**](/plugin/system/plugin-api#builderconfig).In the framework plugin, you can customize the config of the underlying build tool [Rspack](https://rspack.rs), such as `define`, `alias`, and you can also add custom Rspack plugins.
