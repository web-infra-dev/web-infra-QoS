...
Rspress 底层基于 [Rsbuild](https://github.com/web-infra-dev/rsbuild) 来进行文档构建。通过 `builderConfig` 可以对 Rsbuild 进行配置，具体的配置项可以参考 [Rsbuild - 配置](https://rsbuild.rs/zh/config/)。
